...
int main(int argc, char* argv[]) {
    ...
    Shader lightingShader = Shader("shaders/multiple_lights.vert", "shaders/multiple_lights.frag");
    Shader lightCubeShader = Shader("shaders/light_cube.vert", "shaders/light_cube.frag");
